        ...
        <nav className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:block">
            ...
            >
              <Button
                size="sm"
                className="bg-gradient-to-r from-primary to-primary-dark hover:opacity-90 flex items-center gap-2"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
          ...
          <div className="md:hidden py-4 border-t border-gray-200 bg-white/95 backdrop-blur-lg">
            <div className="flex flex-col gap-4">
              ...
              >
                <Button
                  fullWidth
                  className="mt-2 bg-gradient-to-r from-primary to-primary-dark flex items-center justify-center gap-2"
                >
                  <svg
                    className="w-4 h-4"
                    fill="currentColor"
