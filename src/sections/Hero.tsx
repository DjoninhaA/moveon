      ...
      <Container size="wide" className="relative z-10 pt-32 pb-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 bg-primary/5 border border-primary/10 rounded-full">
            ...
            <span className="text-sm text-gray-600 font-medium">Soluções em Tecnologia</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
            ...
            inteligente para otimizar processos e acelerar o crescimento 
            da sua empresa.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            ...
            >
              <Button size="md" className="bg-gradient-to-r from-primary to-primary-dark hover:opacity-90 shadow-lg shadow-primary/25 flex items-center gap-2 text-sm sm:text-base px-4 sm:px-6 py-3">
            ...
            <Button
              variant="outline"
              size="md"
              className="border-primary text-primary hover:bg-primary hover:text-white flex items-center gap-2 text-sm sm:text-base px-4 sm:px-6 py-3"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
