          ...
          <div className="grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-7">
              ...
              <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-gray-900 mb-6 leading-tight">
                Transforme sua empresa com tecnologia inteligente
              </h2>
            ...
            <div className="lg:col-span-5 lg:border-l lg:border-gray-200 lg:pl-10 flex flex-col justify-center gap-6">
              ...
              <div>
                <p className="font-mono text-[11px] tracking-widest text-gray-400 mb-1">TELEFONE</p>
                <p className="text-gray-900 text-sm">{siteConfig.contact.phone}</p>
              </div>
              <div>
                <p className="font-mono text-[11px] tracking-widest text-gray-400 mb-1">LOCALIZAÇÃO</p>
                <p className="text-gray-900 text-sm">{siteConfig.contact.address}</p>
              </div>
            </div>
          </div>
        </div>
